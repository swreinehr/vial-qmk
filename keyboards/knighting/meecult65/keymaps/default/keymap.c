...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_all(
        ...
        KC_LSFT,         KC_Z,  KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,KC_COMM, KC_DOT,  KC_SLSH, KC_ENT      , KC_UP  , KC_END,
        KC_LCTL,      KC_LGUI,    KC_LALT,    KC_SPC,            MO(2),        MO(1),        MO(3),     KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [1] = LAYOUT_all(
	...
	KC_PGDN,       KC_LEFT, KC_DOWN, KC_RIGHT, ____, ____, ____, KC_4, KC_5, KC_6, ____, ____,             ____, ____,
        ____,               ____, ____, KC_PSCR, ____, ____, KC_0, KC_1, KC_2, KC_3, ____, ____,       ____, ____,
    ...
    [3] = LAYOUT_all(
        ...
        ____,         ____, ____, ____, ____, ____,   ____, KC_F9, KC_F10, KC_F11, KC_F12, ____, ____, ____, 
